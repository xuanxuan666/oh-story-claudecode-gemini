...
## 番茄补充：紧迫感三锁 + 大小人物 + 过渡章 + 改文

### 情节紧迫感：时间锁 / 空间锁 / 道德挑战（番茄《新手急救》）

平淡的情节加"锁"立刻紧张：

- **时间锁**：设一个逼近的截止（桌下炸弹 3 分钟爆、"X 天内完成 X 任务"、"三年之期已到"）。反复强调时间流逝，扣人心弦。
- **空间锁**：把故事塞进一个足够小的封闭空间（风雪山庄、无人医院、密室）。空间越小，越能设计出令人信服的巧合——"无巧不成书"，场面不是越大越精彩。
- **道德挑战**：给主角一个两难抉择（杀了昏睡的陌生人就能逃出密室求生：杀，还是不杀？）。时间锁+空间锁给天生危机感，道德挑战给主角的挣扎，戏剧性最大。

三者可叠加：时间锁×空间锁 = 1+1>2；再加道德挑战，读者情绪波动拉满。

### 大人物遇小事 · 小人物遇大事（番茄十二字真言）

编不出精彩情节时套这十二字，靠**身份与环境的极致反差**造戏剧性：

- **大人物遇小事**：把大人物丢进足够小的环境，围绕身份反差写（黑帮老大回校读书、暴走族大佬当中学老师）。用信息差（读者知道主角身份、周围人不知道，怕暴露自带危机感）或反差感（粗俗老师用细腻方法育人）。
- **小人物遇大事**：身份与环境极致反差（手无缚鸡之力的普通人成了超级英雄）。读者一边担心真相暴露，一边好奇他如何化险为夷。最好设计、最实用。

### "不存在过渡章"（番茄《高效改文》）

别把"主角从 A 到 B"当过渡章白写——**过渡章就是制造下一个期待感的铺垫过程**。影视里警察抓捕前不会突然接电话就去抓人、犯人视角也不会坐以待毙：这段要写对手的布局、信息差、危机感、主角是否有防备。推进过程中绝不能让读者失去期待感。过渡段本身该跳则跳（无信息量就删），但"过渡章"这个偷懒概念不存在。

### 改文先看数据（番茄《单章怎么改》）

番茄作家后台"章节读完率"折线的**明显下滑点**就是要改的地方——从下滑那一章的**前一章**开始查。改的原则：在不改动核心剧情、不影响前后阅读的前提下，把造成流失的具体内容（毒点/人设崩/没内容可看的过渡）解决掉；**删多余内心戏，多用行为和语言推动剧情**（读者是来看故事的，不是来看作者主观臆想）。改完等一周左右看读完率是否回升。
