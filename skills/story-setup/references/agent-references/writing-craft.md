...
> 写作技法的 agent 可执行指令（身体化情绪、贯穿道具、场景三维度、句式手术、动作拆解、标点谱系等）。写作全程参考。方法论对齐番茄官方教程（正文示例以短句+句号为底色）。
...
### 情绪外化的三个补充手法（番茄《细节&情绪》）

替换情绪词之外，再叠这三招把情绪"演"到位：

- **把脸拆开写**：别一笔"表情不自然"带过。把脸拆成眼睛/眉毛/嘴角/脸颊，挑 1-2 个有变化的细节，重点写"变化的过程"。
  > 苏念抿了抿嘴，嘴角往上扯了扯，露出一个标准的弧度，可睫毛却低垂着，眼尾还微微泛红。（强颜欢笑：嘴角与睫毛的反差把酸楚演出来）
- **身体反应匹配强度**：强烈情绪下身体比大脑先反应。轻度紧张写"手心微微出汗"，重度写"心跳像要从胸腔里跳出来"；生理反应和外部动作一起出现更立体（"她攥着裙摆的手心全是汗，连呼吸都不敢太大声"）。
- **环境烘托**：① 同频——心情压抑写"天阴沉沉的，云压得很低"；② 相反——刚分手，周围却是"情人节晚上举着玫瑰的人群，橱窗灯亮得晃眼"，用热闹反衬凄凉。
...
**克制 ≠ 稀薄（重要）**：短句直给、去 AI 腔是为了去水，**不是把爽点写瘦**。爽点 / 神迹 / 反差高潮处要给**量感**——把关键效果按物理逻辑逐拍展开、给具体的画面体量（雨在半空停住蒸成白雾、合金刀"滋啦"化成铁水、锁骨上的觉醒印记一道道重新烧亮、境界当场破开），密处要敢密。一路短句留白、把最该爽的地方写得干巴，是"去AI"做过头成了骨架文——**人味来自纹理密度，不是极简**。
...
> **番茄悬念例外（唯一放宽处）**：章尾钩、欲言又止的悬念收尾，番茄常用单个 `……` 制造余韵（如"他如往常那般笑着和我打招呼，那一刻我明显感觉到，他的体温，有些凉……"）。此处允许**克制**使用——一章至多一两处，只放在句末悬念点。但**不得**用 `……` 替代正文中的普通停顿（普通停顿仍用句号/短句/动作），`——`/`—`/`--` 仍**全禁**。

---

## 10. 句式手术（把拥挤长句改成清晰短句）

> 料源：番茄《读者为什么划走·句式专项》+《从本质到方法·代入感》。网文读者要的是顺、快、代入强；句子读着费劲，读者就划走。

### 规则

一句话先过三关：顺不顺、清不清、有没有画面。六招逐条落地，每招配「改前→改后」。

### 招式速查

| 招 | 病 | 改法 |
|---|---|---|
| 断句 | 一句塞好几个动作/场景/情绪，读着累 | 按动作/视线/情绪变化停一下；重要信息单独拎出来 |
| 拆句 | 信息挤成一团，抓不到重点 | 拆成主干句+补充句：先写最重要的动作，再补心理/原因/状态 |
| 说明改画面 | 急着告诉读者"他是什么情绪/什么人" | 能用动作演的就少用空泛说明——让读者从动作里看出来 |
| 抽象改具体 | "很破/很冷/很穷/很吓人"——读者想象不出来 | 把形容词拆成能看见/闻到的具体细节（给证据，不下结论） |
| 冗余改精简 | 一句话绕成三句说，节奏拖 | 能直接说清的不重复铺垫；短不等于单薄，短而准才有力 |
| 一句一事 | 一句话说了好几件事 | 一句只说一件事 |

**硬指标**：一句话最好不超过 50 字。

### 少用"了"字和转折词（去 AI 利器）

`虽然…但是…`、`然而`、`却`、`若…则…`、`因为…所以…` 这些词本身没错，但**用多了会有"强行让读者认同你"的说教感**，读者会觉得"作者在逼我同意"。不必要的"了"字同理要压。写完扫一遍，把多余的转折词和"了"删到只剩真正需要的。
...
**拆句**
> 改前：她在看见走廊尽头那扇本该锁着的门竟然半掩着之后，呼吸一下就停住了，站在原地不敢继续往前走，脑子里飞快闪过昨晚听到的那些传言，越想越觉得后背发凉。
> 改后：她猛地停下脚步，盯住了走廊尽头那扇门。门竟然是半掩着的。她一时没敢再往前走。昨晚听来的那些传言，忽然全涌了上来。她越想越冷，连手心都慢慢渗出了汗。

**说明改画面**
> 改前：他现在非常生气，因为他觉得自己被羞辱了，所以整个人的情绪都很不好。
> 改后：他下颌绷紧，手背上的青筋一点点鼓了起来。那句讽刺还在耳边打转，他紧紧盯着对方，一个字都没回。

**抽象改具体**
> 改前：这是一间很破旧的屋子，生活条件很差。
> 改后：墙皮一块块往下掉，窗框发黑，桌角缺了口，床边那盏灯亮一下灭一下，屋里还飘着一股潮湿的霉味。

### 句式套路 4 式（先动作/先落点/先刺激/单拎重点）

| 套路 | 拆解 | 适合 |
|---|---|---|
| 动作先行 | 先写人物做了什么，再补结果/看到什么/发生什么 | 开场、转场、突发事件；先动作再补，画面感足 |
| 观察落点 | 先写主角看到什么，再补他的判断/情绪/身体反应 | 惊讶、紧张、害怕、心动；先落点再给情绪，代入更自然 |
| 反应承接 | 先抛外部刺激，再紧跟人物的动作/表情/心理/身体变化 | 带出情节变化，尤其转折、消息出现、危险来临 |
| 重点单拎 | 把关键句单独成段，增强冲击 | 反转、揭晓、告白、决裂、死亡通知、身份曝光——越重要的话越给它留位置 |

---

## 11. 动作拆解（把干巴动作写出画面、节奏、人物味）

> 料源：番茄《故事读起来像说明书·动作专项》。动作不是写得越多越好——目标是"写得有效"，让读者像看慢镜头一样看见过程。堆动作、堆形容只会变水文。

### 四招

**1. 大动作拆成 3-5 个连贯小动作**
从"移动、靠近、接触、操作、反应"里挑 3-5 个写出来，至少一处加身体感受（触感/力度/呼吸）。
> 改前：林晚走到桌边，拿起那封信看了一眼。
> 改后：林晚停在桌边，指尖先碰了碰信封边角，像是在确认什么。她把信慢慢抽起来，低头扫了一眼封面上的字，呼吸微微一顿，这才把信纸完全展开。

**2. 二次动作，用肢体替代内心独白**
情绪越复杂，动作越不会一步到位。用"第一反应 + 第二反应"：伸到一半停住、递过去又缩回、想走又慢下来。犹豫就慢、紧张就僵、舍不得就回头。
> 改前：女生把钥匙放在餐桌上推到男生面前。她心里其实很舍不得，这里有他们三年的回忆……（一大段内心戏）
> 改后：女生从包里摸出钥匙，推到男生手边，却在即将收手的一瞬间，猛地按住了钥匙扣上的小熊挂坠。她没有把钥匙收回去，只是死死按着。
（"按住"这个二次动作，把克制、不舍全演出来了，还顺势逼出对方"抬眼看她"的下一步剧情——一个动作推动了情节。）

**3. 按年龄/性别写专属动作**（下表）

| 年龄段 | 动作特点 | 常用词参考 |
|---|---|---|
| 儿童(6-12) | 幅度大、控制力弱、情绪直接写在动作上 | 跑、扑、拽、晃、缩、蹭、扭、踮脚 |
| 青少年(13-18) | 有冲劲、自尊、别扭，嘴上不说动作先暴露 | 想看又移开、想靠近又装不在意、二次动作多 |
| 青壮年(19-35) | 有目的性、控制自己、隐藏情绪、带分寸 | 停顿、克制、稳、细节处微微绷紧 |
| 中年(36-55) | 更稳更省、讲效率，带身份感和生活压力 | 权衡、捏眉心、整理衣袖、沉默后再动作 |
| 老年(56+) | 因身体负担与岁月，行动缓慢 | 扶、撑、挪、顿、喘、摸索、稳了稳 |

注意：年龄不是固定模板，把年龄 + 性格 + 身体状态 + 当下情绪一起考虑，靠细节差异建立人物感，不靠刻板印象。

**4. 把动作写慢，保留停顿节点**
在重要场景/情绪转折处，把被压扁的动作按真实顺序还原；找停顿点（哪一拍卡住、哪一刻乱了、哪一下才真正行动），最后做减法，只留 2-3 个最有张力的节点，不必处处慢写。
> 改前：她听到那句话后站起来跑了出去。
> 改后：那句话落下时，她指尖在桌沿上轻轻蜷了一下。下一秒，她猛地站起身，连看都不敢再看对方一眼，逃也似地冲了出去。
