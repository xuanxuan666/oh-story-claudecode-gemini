...
别只梳理敌我亲疏，围绕四问搭关系：① 每个角色的核心诉求（想要什么）② 底层动因（为什么非要不可）③ 与主角矛盾的具体落点（在哪一点冲突）④ 多边拉扯（制衡/结盟/反目/误会）。给每个重要角色一个**独立目标**，别用"帮主角查案 / 阻止主角查案"这种依附主线的工具化设定。

一个立体人物往往同时存在多种冲突。**混搭冲突四类型**：

| 冲突类型 | 一句话 | 例 |
|---|---|---|
| 利益冲突 | 你想赢，我也想赢 | 全班唯一的推优名额，你上了我就没了（不是谁坏，是只有一个） |
| 理念冲突 | 我们追求的正义不是一种正义 | 都"为孩子好"，一个求当下快乐、一个求长远保障 |
| 情感冲突 | 我在乎你，但我不能站你这边 | 真相会毁掉朋友从小长大的兄弟，怎么选都要亲手伤一个在乎的人 |
| 信息冲突 | 我们掌握的信息不同，判断自然不同 | 看见搭档深夜销毁文件断定他毁证，其实他在毁一封会害主角的信 |

例：主角要对付反派副手独眼龙，而弟弟竟和独眼龙是旧识、还欠他一条命——这条关系线不需主角参与，却让整个局面复杂好看。

### 代入感六大支柱（番茄《代入感》）

"代入感"= 读者觉得"主角就是我、这事正发生在我身上"。六根支柱：

1. **基础信息标签化**：开头百十来字交代清"谁、长什么样、在哪、正在经历什么"，读者先认知主角。一句话能带出身份+特质最好（"小爷我乃镇南府世子林峰……"）。
2. **具体化·可视化·熟悉感（真实世界锚点）**：写读者日常真实接触过、能在脑中浮现的场景（高考后教学楼后的分手）。**关键手法：用真实的品牌 / 平台 / 账号尾号 / 时间戳 / 货币 / 短信摘要当锚点**——"招商银行信用卡支付 6.00 元""建设银行 尾号 7788 于 7月9日11:11 入账，摘要：专属神选之女献上的红包"，比泛写"银行到账了"代入强十倍。接地气不土，越具体越真。
3. **共鸣**：① 认知共鸣——主角的选择/看法和读者重叠（"我也会这样！就该选女三！"）；② 情绪共鸣——用亲情纽带/弱势方/不平等对待压制主角，激起"主角没错，凭什么？"。
4. **欲望与期待感**：基础欲望（不劳而获/高人一等/权势地位）+ 主动欲望（你刻意制造的"情绪缺口"，如先写憋屈、让读者等扬眉吐气那一刻）。
5. **五感代入**：潮湿短袖黏后背、医院消毒水味——用主角五感让画面落地。
6. **人设不完美**：别写十全十美。给个接地气小缺点（名字"李慕婉"其实真名"牛翠花"；霸总回家路上买根淀粉肠），反而拉近距离、留出成长空间。

> **系统 / 养成 / 金手指流额外两招**：① **把核心玩法当场演出来**——戳一戳→小人抱头比中指、投喂→头顶炸金光，别只叙述"有这功能"；② **给女主 / 金手指强身份钩 + 成长可视化**——狐耳狐尾、锁骨上一道道重燃的觉醒印记、当场突破第二条尾巴，一个视觉标签顶十句设定。

（另：少用"了"和转折词——用多了会有"强行让读者认同"的说教感，破坏代入。落地见 writing-craft.md 第 10 节「句式手术」。）
