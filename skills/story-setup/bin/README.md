...
## 写作铁律（通用写法准则 · 由 story-setup 释放到项目）
《写法铁律》**不进 exe 系统提示词**，而是 story-setup 安装时把 `story-setup/references/写作铁律.md` 释放到项目 `设定/写作铁律.md`，作为 Gemini 每章 `--require` 必读的通用网文写法准则——**每本书可各自定制、可覆盖**。本书自带的 `设定/文风.md`·`写法自查.md` 与它冲突时以本书为准。
