...
> **去重导航**：本文聚焦**商业选题 / 卖点 / 用户画像**视角。与其他文件重叠的部分，以对应权威文件为准，本文不再展开：爽点本质与六型 / 情绪模块 / 大高潮 7-10 天节奏 → [plot-emotion-system.md](plot-emotion-system.md)；黄金三章 / 开篇设计 → [opening-design.md](opening-design.md)；金手指四阶段 / 换地图 / 循环 → [plot-core-methods.md](plot-core-methods.md)；期待接力 / 驱动力四步公式 → [hooks-suspense.md](hooks-suspense.md)。
