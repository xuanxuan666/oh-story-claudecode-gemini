...
>
> **去重导航**：本文聚焦金手指设计 / 脑洞文 / 都市高武 / 扫榜拆书 / 阵营剧情 / 改编。下列重叠概念以对应权威文件为准，本文不展开——爱情线好感度 / CP 阶段见 character-relations.md；金手指四阶段演进（基础→升华）见 plot-core-methods.md（本文只讲金手指的拆分与进阶设计）；情绪模块见 plot-emotion-system.md。
