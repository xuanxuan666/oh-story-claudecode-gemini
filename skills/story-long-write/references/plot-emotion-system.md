...
## 番茄补充：先抑后扬 + 爽点密度 + 铺垫过程余波 + 七宗罪

### 爽点"先抑后扬 + 强反馈"（番茄《节奏爽点》）

爽点密集化的落地公式：**小冲突 → 快解决 → 强反馈**，每 3-5 章设计 1 个小爽点，遵循"先抑后扬"：

- **抑**：主角被轻视（"同事说'你这辈子都赚不到 10 万'"）。
- **扬**：主角快速反击（"3 天靠系统赚 20 万，把合同甩桌上"）。
- **反馈**：加"他人震惊"细节（"同事脸色惨白，老板主动加薪"），把爽感锤实。

要点：① 高潮前 3-5 章埋线索/伏笔，让读者递进期待；② 高潮后 1-2 章写"高潮带来的改变"（主线推进/人设成长/关系变化），别让高潮沦为孤立事件；③ 爽点类型别单一（打脸之外加智斗、逆袭、情感满足），避免反复同一种。

### 情节"铺垫 → 过程 → 余波"（番茄《拒绝流水账》）

单薄的故事是跳跃式的（情节 A 直接跳 B）；丰富的故事，每个核心情节（转折/冲突/高潮）都有三段：

- **前置铺垫**：用细节暗示、人物伏笔、环境烘托铺，让转折不突兀、还给读者"恍然大悟"的惊喜。（女主发现男主是凶手前，先埋"他看到父亲旧照眼神躲闪、抽屉里有枚一模一样的铜纽扣"。）
- **增添过程**：别直接写"事情已完成"，补人物的尝试/失败/挣扎/成长（主角赢比赛，写成陷入劣势→用功法A扭转→对手应对→再劣势→杀手锏，层层递进）。
- **延续余波**：每个事件都有后续影响——情绪变化/关系改变/新隐患/新矛盾，为后续埋伏笔、形成联动。

避坑：细节服务节奏和情绪，不是为细节而细节；超过一百字的风景/情绪描写都要想想是不是水了。

### 情感共鸣从"七宗罪"里找（番茄《新手急救》）

一个好故事的情感内驱力，是所有有感情的动物都能理解的原始冲动。从七宗罪找灵感，再用"音量条"往下调成七美德：
...
设计剧情时努力挖这种"刻进 DNA"的情绪；调动情绪靠情节和描写烘托，不靠"他好难过"这种情绪形容词直接说。
