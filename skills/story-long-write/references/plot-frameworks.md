...
>
> **去重导航**：结构理论（三幕/五幕/六幕、《作家之旅》）只作因果链弯折的参考骨架，网文实操以本文的"套路模板/阵营手牌/有进无出"为准；下列重叠概念以对应权威文件为准，本文不展开——情绪模块提炼层级见 plot-emotion-system.md；五幕式各幕功能见 outline-structure-theory.md；阵营手牌法三版本见 plot-special-topics.md；装逼五步 / 爽点释放见 style-combat-face.md。
